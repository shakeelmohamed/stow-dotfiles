...
function getYarnProductionDependencies(cwd) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, new Promise(function (c, e) { return cp.exec('yarn list --json', { cwd: cwd, encoding: 'utf8', env: __assign({}, process.env, { NODE_ENV: 'production' }) }, function (err, stdout) { return err ? e(err) : c(stdout); }); })];
                case 1:
                    raw = _a.sent();
...
function getYarnDependencies(cwd) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, getYarnProductionDependencies(cwd)];
                case 2:
                    deps = _a.sent();
...
function getDependencies(cwd, useYarn) {
