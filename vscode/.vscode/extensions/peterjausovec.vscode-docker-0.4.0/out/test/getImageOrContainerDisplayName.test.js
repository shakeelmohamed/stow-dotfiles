...
const getImageOrContainerDisplayName_1 = require("../explorer/models/getImageOrContainerDisplayName");
suite('getImageOrContainerDisplayName', () => {
    function genTest(fullName, trim, max, expected) {
        test(`${String(fullName)}: ${trim}/${max}`, () => {
            let s2 = getImageOrContainerDisplayName_1.getImageOrContainerDisplayName(fullName, trim, max);
...
//# sourceMappingURL=getImageOrContainerDisplayName.test.js.map